...
void data_types_init(void) {
    ...
    g_rotor.target_mechanical_speed = TARGET_SPEED;
    ...
    g_pwm_period_ctrl = (uint32_t)(200000000.0f / PWM_FREQUENCY_HZ);
    ...
    g_main_clock.useconds = 0;

    // Initialize conditional variables
    #if SPEED_PROFILE == TRAPEZOIDAL
    g_speed_profile.tUp.seconds = 0;
    g_speed_profile.tUp.useconds = 0;
    g_speed_profile.tDown.seconds = 0;
    g_speed_profile.tDown.useconds = 0;
    g_speed_profile.tConst.seconds = 0;
    g_speed_profile.tConst.useconds = 0;
    g_speed_profile.ReferenceValue = TARGET_SPEED;
    #endif
    ...
    #elif CONTROL_MODE == POS_CTRL
    g_angle_controller.kp = 0.0f;
    g_angle_controller.ki = 0.0f;
    ...
    #elif CONTROL_MODE == TORQUE_CTRL
    g_torque_controller.kp = 0.0f;
    g_torque_controller.ki = 0.0f;
